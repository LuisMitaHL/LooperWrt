...
# MT7981 WO firmware is carried in files/mediatek: the 20240823 blob in
# linux-firmware (and in mt76) is stale; MediaTek's vendor feed ships 20260323.
...
define Package/mt7981-wo-firmware/install
	$(INSTALL_DIR) $(1)/lib/firmware/mediatek
	$(INSTALL_DATA) \
		$(CURDIR)/files/mediatek/mt7981_wo.bin \
		$(1)/lib/firmware/mediatek
endef
